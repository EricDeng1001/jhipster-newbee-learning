...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, me.antinux.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, me.antinux.repository.UserRepository.USERS_BY_EMAIL_CACHE);
